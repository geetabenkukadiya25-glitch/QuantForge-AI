"""Confirms adding the Local Artifact Registry (Phase 17.2) didn't touch
or break the Cloud Platform Foundation, Workspace Management, or any
prior engine."""
...
def test_artifact_registry_adds_no_new_path_fields() -> None:
    """This phase is in-memory only -- no new results directory on disk."""
    paths = get_paths()
    assert not hasattr(paths, "artifact_registry_dir")
    assert not hasattr(paths, "cloud_platform_dir")


def test_artifact_modules_import_cleanly_alongside_everything_else() -> None:
    import app.cloud_platform  # noqa: F401
    import app.cloud_platform.artifact  # noqa: F401
    import app.cloud_platform.artifact_manager  # noqa: F401
    import app.cloud_platform.artifact_registry  # noqa: F401
    import app.cloud_platform.artifact_report  # noqa: F401
    import app.cloud_platform.artifact_statistics  # noqa: F401

...
with explorer_col:
    ...
    data, dataset_record = render_dataset_picker(page_key="validation")
...
with workspace_col:
    if data is None:
        st.info("Select or upload historical OHLCV data in the Explorer to run optimization + validation.")
